 ...
 */
final class Version20260318183215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD COLUMN date_fin DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE entreprise ADD COLUMN date_pre_avis DATETIME DEFAULT NULL');
    }
