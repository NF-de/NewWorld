 ...
 */
final class Version20260222225115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, nom, prenom, created_at, updated_at, last_login FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, created_at, updated_at, last_login) SELECT id, email, roles, password, nom, prenom, created_at, updated_at, last_login FROM __temp__user');
