 ...
 */
final class Version20260319150116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD COLUMN cause_refus VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__entreprise AS SELECT id, user_id, nom, adresse, ville, code_postal, siret, status, email, telephone, date_validation, date_archivage, date_mise_a_jour, date_fin, date_pre_avis FROM entreprise');
        ...
        $this->addSql('INSERT INTO entreprise (id, user_id, nom, adresse, ville, code_postal, siret, status, email, telephone, date_validation, date_archivage, date_mise_a_jour, date_fin, date_pre_avis) SELECT id, user_id, nom, adresse, ville, code_postal, siret, status, email, telephone, date_validation, date_archivage, date_mise_a_jour, date_fin, date_pre_avis FROM __temp__entreprise');
